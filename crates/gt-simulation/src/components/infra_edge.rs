...
pub struct InfraEdge {
    ...
    /// Last tick this edge was damaged (for insurance premium calculation).
    #[serde(default)]
    pub last_damage_tick: Option<u64>,
    /// Revenue generated by this edge during the last tick (transit fees, set by revenue system).
    #[serde(default)]
