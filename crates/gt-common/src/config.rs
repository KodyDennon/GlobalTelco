    ...
    pub fn from_era(era: Era) -> Self {
        match era {
            ...
            Era::Internet => Self {
                ...
                available_node_types: vec!["CentralOffice", "ExchangePoint", "DataCenter", "SatelliteGround"],
                available_edge_types: vec!["Copper", "FiberOptic", "Microwave", "Satellite", "Submarine"],
            },
            Era::Modern => Self {
                name: "Modern",
                year_start: 2010,
                ...
                available_node_types: vec!["CentralOffice", "ExchangePoint", "CellTower", "DataCenter", "SatelliteGround", "SubmarineLanding"],
                available_edge_types: vec!["Copper", "FiberOptic", "Microwave", "Satellite", "Submarine"],
            },
            Era::NearFuture => Self {
                name: "Near Future",
                ...
                available_node_types: vec!["CentralOffice", "ExchangePoint", "CellTower", "DataCenter", "SatelliteGround", "SubmarineLanding", "WirelessRelay"],
