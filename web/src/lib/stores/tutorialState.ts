...
const TUTORIAL_STEPS: TutorialStep[] = [
	...
	{ id: 'build_node', title: 'Build Your First Node', text: 'Click the "+ Node" button in the toolbar, then click a land parcel on the map. Choose a node type from the build menu to place infrastructure.', highlightSelector: '.build-buttons', position: 'bottom-left' },
