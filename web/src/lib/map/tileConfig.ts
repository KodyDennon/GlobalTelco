...
export const satelliteMapStyle: StyleSpecification = {
    ...
    sources: {
        ...
        openmaptiles: {
            ...
            attribution: '<a href="https://openfreemap.org">OpenFreeMap</a> | <a href="https://openstreetmap.org">OSM</a>'
        }
    },
    layers: [
        ...
        // Country boundaries — subtle dashed lines over satellite
        {
            id: 'boundary-country',
            type: 'line',
            source: 'openmaptiles',
        ...
        // Country labels — readable over satellite
        {
            id: 'label-country',
            type: 'symbol',
            source: 'openmaptiles',
 ...
 * Has full feature parity with real earth mode (overlays, borders, labels, etc.)
 */
